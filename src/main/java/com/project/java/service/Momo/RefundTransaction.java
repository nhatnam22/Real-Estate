...
import com.project.java.model.Momo.RefundMoMoRequest;
import com.project.java.model.Momo.RefundMoMoResponse;
...
public class RefundTransaction extends AbstractProcess<RefundMoMoRequest, RefundMoMoResponse> {
	...
	private static final Logger LogUtils = LoggerFactory.getLogger(RefundTransaction.class);
